 ...
 * @LastEditors: 孙浩然
 * @LastEditTime: 2020-07-06 21:15:32
...
- [1.java基础-数据类型-8种常见类型](#1java基础-数据类型-8种常见类型)
  - [1-1：八种数据类型是什么？](#1-1八种数据类型是什么)
  - [1-2：为什么byte类型是-128~+127](#1-2为什么byte类型是-128127)
  - [1-3：java为什么除了基本数据类型还要有引用数据类型](#1-3java为什么除了基本数据类型还要有引用数据类型)
  - [1-4：什么是单精度和双精度？](#1-4什么是单精度和双精度)
  - [1-5：什么是浮点数？](#1-5什么是浮点数)
- [2.java基础-数据类型-自动拆装箱](#2java基础-数据类型-自动拆装箱)
  - [2-1：为什么要有自动拆装箱](#2-1为什么要有自动拆装箱)
  - [2-2：Integer缓存机制](#2-2integer缓存机制)
  - [2-3：Integer的源码分析](#2-3integer的源码分析)
  - [2-4：自动拆装箱的原理](#2-4自动拆装箱的原理)
  - [2-5:自动拆装箱使用场景](#2-5自动拆装箱使用场景)
  - [2-6：自动拆装箱带来的问题](#2-6自动拆装箱带来的问题)
- [3.java基础-关键字-访问权限关键字](#3java基础-关键字-访问权限关键字)
  - [3-1：访问控制关键字级别](#3-1访问控制关键字级别)
  - [3-2: 通过反射访问private成员和方法，既然能访问为什么要private？](#3-2-通过反射访问private成员和方法既然能访问为什么要private)
- [4.java基础-关键字-static](#4java基础-关键字-static)
  - [4-1:static使用场景](#4-1static使用场景)
- [5.java基础-关键字-final关键字](#5java基础-关键字-final关键字)
  - [5-1 final关键字使用特点](#5-1-final关键字使用特点)
  - [5-2 final使用场景](#5-2-final使用场景)
- [6.java基础-关键字-this关键字和super关键字](#6java基础-关键字-this关键字和super关键字)
- [7.java基础-关键字-transient](#7java基础-关键字-transient)
  - [7-1： transient使用场景](#7-1-transient使用场景)
- [8.java基础-关键字-synchronized关键字](#8java基础-关键字-synchronized关键字)
  - [8-1：synchronized关键字理解](#8-1synchronized关键字理解)
  - [8-2：JDK1.6优化有哪些？](#8-2jdk16优化有哪些)
- [8-3：说说⾃⼰是怎么使⽤ synchronized 关键字，在项⽬中⽤到了吗](#8-3说说是怎么使-synchronized-关键字在项中到了吗)
  - [8-4：synchronized关键字最主要的三种使⽤⽅式（与单例模式结合比较高）](#8-4synchronized关键字最主要的三种使式与单例模式结合比较高)
  - [8-5：synchronized 关键字底层原理](#8-5synchronized-关键字底层原理)
  - [8-6：synchronized和ReentrantLock的区别](#8-6synchronized和reentrantlock的区别)
- [9.java基础-关键字-volatile关键字](#9java基础-关键字-volatile关键字)
  - [9-1：volatile 关键字作用以及Java内存数据不一致](#9-1volatile-关键字作用以及java内存数据不一致)
  - [9-2：说说 synchronized 关键字和 volatile 关键字的区别](#9-2说说-synchronized-关键字和-volatile-关键字的区别)
...
- [10.java基础-集合-hashmap](#10java基础-集合-hashmap)
  ...
  - [10-9：java8为什么要对hashmap进行改造，用红黑树替代](#10-9java8为什么要对hashmap进行改造用红黑树替代)
  - [10-10：HashMap的扩容机制](#10-10hashmap的扩容机制)
  - [10-11：请解释一下HashMap的参数loadFactor，它的作用是什么？](#10-11请解释一下hashmap的参数loadfactor它的作用是什么)
  - [10-12：HashMap的树化门槛为什么是8](#10-12hashmap的树化门槛为什么是8)
  - [10-13：HashMap的扩容因子为什么是0.75](#10-13hashmap的扩容因子为什么是075)
  - [10-14:为什么默认初始化桶数组大小为16](#10-14为什么默认初始化桶数组大小为16)
  - [10-15:hashMap是否线程安全](#10-15hashmap是否线程安全)
  - [10-16：线程安全的Map](#10-16线程安全的map)
  - [10-17：hashmap为什么是2的秘方次](#10-17hashmap为什么是2的秘方次)
  - [10-18：hashmap的多线程导致死循环](#10-18hashmap的多线程导致死循环)
- [11.java基础-集合-ConcurrentHashMap](#11java基础-集合-concurrenthashmap)
...
- [12.java基础-集合-TreeMap](#12java基础-集合-treemap)
  ...
  - [11-4：为什么要重写hashcode与equals](#11-4为什么要重写hashcode与equals)
- [12.java基础-集合-Collection](#12java基础-集合-collection)
  - [12-1：ArrayList数组长度源码](#12-1arraylist数组长度源码)
  - [12-2：arraylist扩容机制](#12-2arraylist扩容机制)
  - [12-3：遍历删除arraylist元素](#12-3遍历删除arraylist元素)
  - [12-4：hashset原理](#12-4hashset原理)
  - [12-5：Enumeration和itrator区别](#12-5enumeration和itrator区别)
  - [12-6：comparable和Comparator的区别](#12-6comparable和comparator的区别)
  - [12-7：SynchronizedList](#12-7synchronizedlist)
- [13.java基础-集合-Collections](#13java基础-集合-collections)
  - [13-1：Collection和collections区别](#13-1collection和collections区别)
- [14.java基础-集合-Arrays](#14java基础-集合-arrays)
- [15.java基础-集合-集合大比较（区别和使用场景）](#15java基础-集合-集合大比较区别和使用场景)
  - [15-1：set和list、map的区别](#15-1set和listmap的区别)
  - [15-2：arraylist、linkedlist区别和适用场景](#15-2arraylistlinkedlist区别和适用场景)
  - [15-3：vector、Arraylist区别和适用场景](#15-3vectorarraylist区别和适用场景)
  - [15-4：treeset、hashset区别和适用场景](#15-4treesethashset区别和适用场景)
  - [15-5：HashMap、Treemap区别和适用场景](#15-5hashmaptreemap区别和适用场景)
