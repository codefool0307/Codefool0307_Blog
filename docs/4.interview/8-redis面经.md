...
- [1.缓存](#1缓存)
  ...
  - [1-6：为什么要⽤ redis/为什么要⽤缓存](#1-6为什么要-redis为什么要缓存)
  - [1-7：为什么要⽤ redis ⽽不⽤ map/guava 做缓存?](#1-7为什么要-redis-不-mapguava-做缓存)
  - [1-8：缓存数据的处理流程是怎样的？](#1-8缓存数据的处理流程是怎样的)
- [2.分布式缓存技术](#2分布式缓存技术)
...
## 1-7：为什么要⽤ redis ⽽不⽤ map/guava 做缓存?
