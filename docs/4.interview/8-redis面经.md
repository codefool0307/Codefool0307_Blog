...
- [1.缓存](#1缓存)
  ...
  - [Redis与Memcached区别](#redis与memcached区别)
  - [为什么说Redis快](#为什么说redis快)
- [缓存雪崩](#缓存雪崩)
  - [什么是缓存雪崩](#什么是缓存雪崩)
  - [如何解决 Redis 的并发竞争 Key 问题](#如何解决-redis-的并发竞争-key-问题)
  - [Redis的数据结构](#redis的数据结构)
  - [介绍zset类型的底层结构](#介绍zset类型的底层结构)
  - [redis怎么保证原子性？](#redis怎么保证原子性)
  - [Redis单线程，如何实现异步和非阻塞](#redis单线程如何实现异步和非阻塞)
  - [redis为什么是单进程？](#redis为什么是单进程)
  - [什么时候可以用多线程](#什么时候可以用多线程)
  - [引出redis的分布式锁](#引出redis的分布式锁)
  - [redis负载多少，测过没有](#redis负载多少测过没有)
  - [Redis的zset原理](#redis的zset原理)
