...
- [5.事务](#5事务)
  ...
  - [5-4：隔离级别的原理](#5-4隔离级别的原理)
  - [5-5：MySQL 中RC和RR隔离级别的区别](#5-5mysql-中rc和rr隔离级别的区别)
...
- [11.常用sql的语句](#11常用sql的语句)
  ...
  - [11-19：数据库热备份与冷备份](#11-19数据库热备份与冷备份)
- [12.主从复制](#12主从复制)
...
- [14.存储过程与函数](#14存储过程与函数)
  - [14-1：什么是存储过程？](#14-1什么是存储过程)
  - [14-2：有哪些优缺点？](#14-2有哪些优缺点)
- [15.触发器](#15触发器)
...
事务隔离级别是并发控制的整体解决方案，其实际上是综合利用各种类型的锁和行版本控制，来解决并发问题。锁是数据库并发控制的内部机制，是基础。对用户来说，只
有当事务隔离级别无法解决一些并发问题和需求时，才有必要在语句中手动设置锁
