 ...
 * @LastEditTime: 2020-11-26 20:18:52
 * @FilePath: \docs\4.interview\1-java基础面经.md
 * @博客地址: 个人博客，如果各位客官觉得不错，请点个赞，谢谢。[地址](https://codefool0307.github.io/JavaScholar/#/)
--> 
<!-- TOC -->autoauto- [1.java基础-java特性](#1java基础-java特性)auto    - [1-1：java特点](#1-1java特点)auto- [2.java基础-面对对象-综述](#2java基础-面对对象-综述)auto    - [2-1：面对对象三大特征(特点)](#2-1面对对象三大特征特点)auto    - [2-2：面对对象的五大原则](#2-2面对对象的五大原则)auto    - [2-3：Java创建对象方式](#2-3java创建对象方式)auto    - [2-4：new abc是在堆里面呢？](#2-4new-abc是在堆里面呢)auto    - [2-4：⾯向过程性能⽐⾯向对象⾼](#2-4⾯向过程性能⽐⾯向对象⾼)auto- [3.java基础-面对对象-多态](#3java基础-面对对象-多态)auto    - [3-1：多态的必要条件（实现方式）](#3-1多态的必要条件实现方式)auto    - [3-2：多态机制](#3-2多态机制)auto    - [3-3：多态的好处](#3-3多态的好处)auto    - [3-4：多态的例子](#3-4多态的例子)auto- [4.java基础-面对对象-重载与重写](#4java基础-面对对象-重载与重写)auto    - [4-1：重载与重写](#4-1重载与重写)auto    - [4-2：Java 中是否可以覆盖(override)一个 private 或者是 static 的方法？](#4-2java-中是否可以覆盖override一个-private-或者是-static-的方法)auto- [5.java基础-面对对象-接口与抽象类](#5java基础-面对对象-接口与抽象类)auto    - [5-1：接⼝和抽象类的区别是什么？](#5-1接⼝和抽象类的区别是什么)auto    - [5-2：Java 抽象类可以有构造函数吗？作用是什么](#5-2java-抽象类可以有构造函数吗作用是什么)auto    - [5-3: Java 抽象类可以实现接口吗？ 它们需要实现所有的方法吗？](#5-3-java-抽象类可以实现接口吗-它们需要实现所有的方法吗)auto    - [5-4：Java 抽象类可以是 final 的吗？](#5-4java-抽象类可以是-final-的吗)auto    - [5-5：Java 抽象类可以有 static 方法吗？](#5-5java-抽象类可以有-static-方法吗)auto    - [5-6：可以创建抽象类的实例吗？](#5-6可以创建抽象类的实例吗)auto    - [5-7：抽象类必须有抽象方法吗？](#5-7抽象类必须有抽象方法吗)auto    - [5-8：何时选用抽象类而不是接口？](#5-8何时选用抽象类而不是接口)auto    - [5-9：Java中的抽象方法是什么？](#5-9java中的抽象方法是什么)auto    - [5-10：Java抽象类中可以包含main方法吗？](#5-10java抽象类中可以包含main方法吗)auto    - [5-11：创建⼀个对象⽤什么运算符?对象实体与对象引⽤有何不同?](#5-11创建⼀个对象⽤什么运算符对象实体与对象引⽤有何不同)auto    - [5-12：interface实现方法](#5-12interface实现方法)auto- [6.java基础-值传递与引用传递](#6java基础-值传递与引用传递)auto- [7.java基础-深拷贝与浅拷贝](#7java基础-深拷贝与浅拷贝)auto    - [7-1：深拷贝与浅拷贝](#7-1深拷贝与浅拷贝)auto    - [7-2：浅拷贝方法](#7-2浅拷贝方法)auto    - [7-3：深拷贝方法](#7-3深拷贝方法)auto- [8.java基础-面对对象-构造器](#8java基础-面对对象-构造器)auto    - [8-1：⼀个类的构造⽅法的作⽤是什么? 若⼀个类没有声明构造⽅法，该程序能正确执⾏吗? 为什么?](#8-1⼀个类的构造⽅法的作⽤是什么-若⼀个类没有声明构造⽅法该程序能正确执⾏吗-为什么)auto    - [8-2：构造⽅法有哪些特性？](#8-2构造⽅法有哪些特性)auto- [9.java基础-面对对象-静态与非静态](#9java基础-面对对象-静态与非静态)auto    - [9-1：静态⽅法和实例⽅法有何不同](#9-1静态⽅法和实例⽅法有何不同)auto    - [9-2：静态变量和实例变量的区别？](#9-2静态变量和实例变量的区别)auto- [10.java基础-运算符-相等问题](#10java基础-运算符-相等问题)auto    - [10-1： == 与 equals](#10-1--与-equals)auto    - [10-2：为什么要重写hashcode与equals](#10-2为什么要重写hashcode与equals)auto    - [10-3：重写equals不重写hashcode会出现什么问题](#10-3重写equals不重写hashcode会出现什么问题)auto    - [10-4：为什么两个对象有相同的hashcode值，它们也不一定是相等的？](#10-4为什么两个对象有相同的hashcode值它们也不一定是相等的)auto    - [10-5：hashcode和equals源码写一下](#10-5hashcode和equals源码写一下)auto    - [10-5：说说&和&&的区别。](#10-5说说和的区别)auto    - [10-6：用最有效率的方法算出 2 乘以 8 等于几?](#10-6用最有效率的方法算出-2-乘以-8-等于几)auto    - [10-7：i++和++i的区别，及其线程安全问题](#10-7i和i的区别及其线程安全问题)auto- [11.java基础-数据类型-8种常见类型](#11java基础-数据类型-8种常见类型)auto    - [11-1：八种数据类型是什么？-中兴](#11-1八种数据类型是什么-中兴)auto    - [11-2：数据类型的范围](#11-2数据类型的范围)auto    - [11-3：为什么byte类型是-128~+127](#11-3为什么byte类型是-128127)auto    - [11-4：java为什么除了基本数据类型还要有引用数据类型](#11-4java为什么除了基本数据类型还要有引用数据类型)auto    - [11-5：String为什么不是基本数据类型-字节](#11-5string为什么不是基本数据类型-字节)auto- [12.java基础-数据类型-自动拆装箱](#12java基础-数据类型-自动拆装箱)auto    - [12-1：为什么要有自动拆装箱](#12-1为什么要有自动拆装箱)auto    - [12-2：Integer缓存机制](#12-2integer缓存机制)auto    - [12-3：自动拆装箱的原理](#12-3自动拆装箱的原理)auto    - [12-4：自动拆装箱使用场景](#12-4自动拆装箱使用场景)auto    - [12-5：自动拆装箱带来的问题](#12-5自动拆装箱带来的问题)auto    - [12-6：String转出int型， 判断能不能转？ 如何转？](#12-6string转出int型-判断能不能转-如何转)auto    - [12-7：short s1 = 1; s1 = s1 + 1;有什么错? short s1 = 1; s1+=1;有什么错?](#12-7short-s1--1-s1--s1--1有什么错-short-s1--1-s11有什么错)auto    - [12-8：int与Integer区别](#12-8int与integer区别)auto- [13.java基础-关键字-访问权限关键字](#13java基础-关键字-访问权限关键字)auto    - [13-1：访问控制关键字级别](#13-1访问控制关键字级别)auto    - [13-2: 通过反射访问private成员和方法，既然能访问为什么要private？](#13-2-通过反射访问private成员和方法既然能访问为什么要private)auto- [14.java基础-关键字-static](#14java基础-关键字-static)auto    - [14-1：static使用场景](#14-1static使用场景)auto- [15.java基础-关键字-final关键字](#15java基础-关键字-final关键字)auto    - [15-1：final关键字使用特点](#15-1final关键字使用特点)auto    - [15-2：final, finally, finalize 的区别。](#15-2final-finally-finalize-的区别)auto    - [15-3：使用 final 关键字修饰一个变量时，是引用不能变，还是引用的对象不能变？](#15-3使用-final-关键字修饰一个变量时是引用不能变还是引用的对象不能变)auto- [16.java基础-关键字-this关键字和super关键字](#16java基础-关键字-this关键字和super关键字)auto- [17.java基础-关键字-transient](#17java基础-关键字-transient)auto- [18.java基础-集合map-hashmap的数据结构](#18java基础-集合map-hashmap的数据结构)auto    - [18-1：hashmap的数据结构](#18-1hashmap的数据结构)auto    - [18-2；为什么JDK8时候引入了红黑树？](#18-2为什么jdk8时候引入了红黑树)auto    - [18-3：为什么不把链表全部换为红黑树](#18-3为什么不把链表全部换为红黑树)auto    - [18-4：为什么是使用红黑树而不是AVL树？](#18-4为什么是使用红黑树而不是avl树)auto    - [18-5：为什么在JDK1.7的时候是先进行扩容后进行插入，而在JDK1.8的时候则是先插入后进行扩容的呢？](#18-5为什么在jdk17的时候是先进行扩容后进行插入而在jdk18的时候则是先插入后进行扩容的呢)auto    - [18-6：为什么在JDK1.8中进行对HashMap优化的时候，把链表转化为红黑树的阈值是8,而不是7或者不是20呢（面试蘑菇街问过）](#18-6为什么在jdk18中进行对hashmap优化的时候把链表转化为红黑树的阈值是8而不是7或者不是20呢面试蘑菇街问过)auto    - [18-7：扰动函数以及作用](#18-7扰动函数以及作用)auto    - [18-8：哈希冲突的解决方法](#18-8哈希冲突的解决方法)auto    - [18-9：HashMap的put操作](#18-9hashmap的put操作)auto    - [18-10：HashMap的get操作](#18-10hashmap的get操作)auto    - [18-11：hashmap的get和put操作的时间复杂度](#18-11hashmap的get和put操作的时间复杂度)auto    - [18-12：hashmap的String类型如何计算hashcode的](#18-12hashmap的string类型如何计算hashcode的)auto    - [18-13：reHash过程](#18-13rehash过程)auto    - [18-14：hash函数以及常用方法](#18-14hash函数以及常用方法)auto    - [18-15：HashMap为什么要树化?](#18-15hashmap为什么要树化)auto    - [18-16：hashmap树化门槛及作用](#18-16hashmap树化门槛及作用)auto    - [18-17：hashmap的特性](#18-17hashmap的特性)auto    - [18-18：HashMap为什么可以插入空值?](#18-18hashmap为什么可以插入空值)auto    - [18-19：JDK的hashmap与Redis的hashmap的区别](#18-19jdk的hashmap与redis的hashmap的区别)auto    - [18-20：为什么要两次hash](#18-20为什么要两次hash)auto- [19.java基础-集合map-hashmap源码数值分析](#19java基础-集合map-hashmap源码数值分析)auto    - [19-1：HashMap中(tab.length - 1) & hash作用](#19-1hashmap中tablength---1--hash作用)auto    - [19-2：请解释一下HashMap的参数loadFactor，它的作用是什么？](#19-2请解释一下hashmap的参数loadfactor它的作用是什么)auto    - [19-3：HashMap的扩容因子为什么是0.75](#19-3hashmap的扩容因子为什么是075)auto    - [19-4：为什么默认初始化桶数组大小为16](#19-4为什么默认初始化桶数组大小为16)auto    - [19-5：hashmap为什么是2的次幂](#19-5hashmap为什么是2的次幂)auto- [20.java基础-集合map-hashmap线程问题](#20java基础-集合map-hashmap线程问题)auto    - [20-1：hashMap是否线程安全](#20-1hashmap是否线程安全)auto    - [20-2：为什么hashmap中String、integer包装类适合作为key](#20-2为什么hashmap中stringinteger包装类适合作为key)auto    - [20-3：线程安全的Map](#20-3线程安全的map)auto    - [20-4：设计线程安全的map](#20-4设计线程安全的map)auto- [21.java基础-集合map-ConcurrentHashMap](#21java基础-集合map-concurrenthashmap)auto    - [21-1：ConcurrentHashMap的底层实现](#21-1concurrenthashmap的底层实现)auto    - [21-2：为何会出现ConcurrenHashMap?](#21-2为何会出现concurrenhashmap)auto    - [21-3：为什么ConcurrentHashMap（hashtable）为何不支持null键和null值](#21-3为什么concurrenthashmaphashtable为何不支持null键和null值)auto    - [21-4：ConcurrentHashMap的put操作](#21-4concurrenthashmap的put操作)auto    - [21-5：分段锁原理](#21-5分段锁原理)auto    - [21-6：hashmap与ConcurrentHashMap中put的区别](#21-6hashmap与concurrenthashmap中put的区别)auto    - [21-7：扩容机制](#21-7扩容机制)auto    - [21-8：什么时候会发生扩容机制](#21-8什么时候会发生扩容机制)auto- [22.java基础-集合map-TreeMap](#22java基础-集合map-treemap)auto    - [22-1：TreeMap底层原理：](#22-1treemap底层原理)auto    - [22-2：使用场景](#22-2使用场景)auto- [23.java基础-集合map-LinkedHashmap](#23java基础-集合map-linkedhashmap)auto    - [23-1：linkedhashmap的底层原理](#23-1linkedhashmap的底层原理)auto- [24.java基础-集合map-HashTable](#24java基础-集合map-hashtable)auto    - [24-1：HashTable的底层原理](#24-1hashtable的底层原理)auto- [25.java基础-集合list-ArrayList](#25java基础-集合list-arraylist)auto    - [25-1：数组(Array)和列表(ArrayList)有什么区别？ 什么时候应该使用 Array 而不是ArrayList？](#25-1数组array和列表arraylist有什么区别-什么时候应该使用-array-而不是arraylist)auto    - [25-2：扩容机制](#25-2扩容机制)auto    - [25-3：ArrayList的add操作](#25-3arraylist的add操作)auto    - [25-4：Arraylist初始大小以及扩容大小](#25-4arraylist初始大小以及扩容大小)auto    - [25-5：那如何解决ArrayList线程不安全问题呢？](#25-5那如何解决arraylist线程不安全问题呢)auto- [26.java基础-集合list-vector](#26java基础-集合list-vector)auto    - [26-1：Vector是保证线程安全的](#26-1vector是保证线程安全的)auto- [27.java基础-集合list-linkedlist](#27java基础-集合list-linkedlist)auto- [28.java基础-集合set-HashSet](#28java基础-集合set-hashset)auto    - [28-1：hashset原理](#28-1hashset原理)auto    - [28-2：hashSet的内存泄漏](#28-2hashset的内存泄漏)auto    - [28-3：为什么HashSet不安全](#28-3为什么hashset不安全)auto    - [28-4：如何保证线程安全](#28-4如何保证线程安全)auto- [29.java基础-集合set-TreeSet](#29java基础-集合set-treeset)auto    - [29-1：TreeSet原理](#29-1treeset原理)auto- [30.java基础-集合set-LinkedSet](#30java基础-集合set-linkedset)auto    - [30-1：LinkedSet原理](#30-1linkedset原理)auto- [31.java基础-集合-集合大比较（区别和使用场景）](#31java基础-集合-集合大比较区别和使用场景)auto    - [31-1：set和list、map的区别](#31-1set和listmap的区别)auto    - [31-2：arraylist、linkedlist区别和适用场景](#31-2arraylistlinkedlist区别和适用场景)auto    - [31-3：vector、Arraylist区别和适用场景](#31-3vectorarraylist区别和适用场景)auto    - [31-4：HashMap、Treemap、linkedHashMap区别和适用场景](#31-4hashmaptreemaplinkedhashmap区别和适用场景)auto    - [31-5：HashTable、Hashmap区别和适用场景](#31-5hashtablehashmap区别和适用场景)auto    - [31-6： ConcurrentHashMap、Hashmap区别和适用场景](#31-6-concurrenthashmaphashmap区别和适用场景)auto    - [31-7： Hashset、Hashmap区别和适用场景](#31-7-hashsethashmap区别和适用场景)auto    - [31-8：treeset、hashset区别和适用场景](#31-8treesethashset区别和适用场景)auto    - [31-9：JAVA集合类](#31-9java集合类)auto    - [31-10：并发集合](#31-10并发集合)auto    - [31-11：并发集合出现的原因](#31-11并发集合出现的原因)auto    - [31-11：collection与collections的区别](#31-11collection与collections的区别)auto    - [31-12：Collections有哪些静态方法](#31-12collections有哪些静态方法)auto- [32.java基础-设计类问题](#32java基础-设计类问题)auto    - [32-1：如果想要一个key对应多个Value的话，怎么设计Map](#32-1如果想要一个key对应多个value的话怎么设计map)auto    - [32-2：插入一万个元素之后会不会扩容，扩容扩多少](#32-2插入一万个元素之后会不会扩容扩容扩多少)auto    - [32-3：创建一个对象HashMap<Integer,Integer> map=new HashMap<>先put(10),然后get(new Long(10))结果是多少？](#32-3创建一个对象hashmapintegerinteger-mapnew-hashmap先put10然后getnew-long10结果是多少)auto    - [32-4：两个线程同时操作一个集合，一个线程读，一个线程写。有可能会产生并发问题吗？](#32-4两个线程同时操作一个集合一个线程读一个线程写有可能会产生并发问题吗)auto- [33.java基础-IO-各种流](#33java基础-io-各种流)auto    - [33-1：为何还要有字符流](#33-1为何还要有字符流)auto    - [33-2：字节流和字符流区别](#33-2字节流和字符流区别)auto    - [33-3：同步、异步与阻塞、非阻塞](#33-3同步异步与阻塞非阻塞)auto    - [33-4：BIO\NIO\AIO区别](#33-4bio\nio\aio区别)auto    - [33-5：linux的5种IO模型](#33-5linux的5种io模型)auto    - [33-6：IO多路复用](#33-6io多路复用)auto    - [33-7：三种常用的实现方式-select](#33-7三种常用的实现方式-select)auto    - [33-8：三种常用的实现方式-poll](#33-8三种常用的实现方式-poll)auto    - [33-9：三种常用的实现方式-epoll](#33-9三种常用的实现方式-epoll)auto    - [33-10：三种常用的实现方式区别](#33-10三种常用的实现方式区别)auto- [34.java基础-反射](#34java基础-反射)auto    - [34-1：什么是反射](#34-1什么是反射)auto    - [34-2：获取class对象方法](#34-2获取class对象方法)auto    - [34-3：Class.forName和classloader.loadClass的区别](#34-3classforname和classloaderloadclass的区别)auto    - [34-4：哪些类不能反射](#34-4哪些类不能反射)auto    - [34-5：反射优缺点](#34-5反射优缺点)auto    - [34-6：反射的应用场景](#34-6反射的应用场景)auto- [35.java基础-注解](#35java基础-注解)auto    - [35-1：元注解以及分类](#35-1元注解以及分类)auto    - [35-2：Java常用注解](#35-2java常用注解)auto- [36.java基础-泛型](#36java基础-泛型)auto    - [36-1：什么是泛型](#36-1什么是泛型)auto    - [36-2：编译器如何处理泛型](#36-2编译器如何处理泛型)auto    - [36-3：为什么Java要用这种编译器](#36-3为什么java要用这种编译器)auto    - [36-4: 什么是类型擦除](#36-4-什么是类型擦除)auto    - [36-5：类型擦除过程](#36-5类型擦除过程)auto    - [36-6：泛型带来的问题](#36-6泛型带来的问题)auto    - [36-7：List泛型和原始类型List之间的区别?](#36-7list泛型和原始类型list之间的区别)auto    - [36-8：List泛型和原始类型List泛型之间的区别?](#36-8list泛型和原始类型list泛型之间的区别)auto    - [36-9:子类继承父类的public可以写成private吗](#36-9子类继承父类的public可以写成private吗)auto    - [36-10：多态时是否会出现类型擦除](#36-10多态时是否会出现类型擦除)auto- [37-java基础-异常](#37-java基础-异常)auto    - [37-1：异常的分类](#37-1异常的分类)auto    - [37-2：Java 中的两种异常类型是什么？ 他们有什么区别？](#37-2java-中的两种异常类型是什么-他们有什么区别)auto    - [37-3：异常类型](#37-3异常类型)auto    - [37-4：什么是OOM？常见有哪些OOM？](#37-4什么是oom常见有哪些oom)auto    - [37-3：异常链](#37-3异常链)auto- [38.java基础-常用类-String](#38java基础-常用类-string)auto    - [38-1：String为什么是final的？](#38-1string为什么是final的)auto    - [38-2：拼接方式](#38-2拼接方式)auto    - [38-3: String、StringBuffer和StringBuilder区别](#38-3-stringstringbuffer和stringbuilder区别)auto    - [38-4：StringBuffer如何实现线程安全](#38-4stringbuffer如何实现线程安全)auto    - [38-5：String 和 char[] 数组谁更适合存密码](#38-5string-和-char-数组谁更适合存密码)auto    - [38-6：String str = new String("abc");创建了几个对象-百度，京东](#38-6string-str--new-stringabc创建了几个对象-百度京东)auto    - [38-7：处理数据量较大的字符串用string还是stringbuilder，为什么](#38-7处理数据量较大的字符串用string还是stringbuilder为什么)auto    - [38-8：为什么StringBuffer和StringBuilder比String更快（不变性）](#38-8为什么stringbuffer和stringbuilder比string更快不变性)auto    - [38-9：如何把一段逗号分割的字符串转换成一个数组?](#38-9如何把一段逗号分割的字符串转换成一个数组)auto    - [38-10：String的内部属性](#38-10string的内部属性)auto    - [38-11：String的常用方法](#38-11string的常用方法)auto- [39.java基础-常用类-枚举](#39java基础-常用类-枚举)auto    - [39-1：enum线程安全](#39-1enum线程安全)auto    - [39-2: switch 是否可用于String类型的判断，Java哪个版本之后有此功能的](#39-2-switch-是否可用于string类型的判断java哪个版本之后有此功能的)auto- [40.Java基础-常用类-时间类](#40java基础-常用类-时间类)auto    - [40-1：SimpDateFormat是线程不安全的类，不要定义为static变量，如果定义，必须加锁或工具类](#40-1simpdateformat是线程不安全的类不要定义为static变量如果定义必须加锁或工具类)auto- [41.java基础-常用类-Object类](#41java基础-常用类-object类)auto    - [41-1：Object类有哪些方法](#41-1object类有哪些方法)auto    - [41-2：为什么操作线程方法会在Object对象中](#41-2为什么操作线程方法会在object对象中)auto- [42.java基础-序列化](#42java基础-序列化)auto    - [42-1：什么是序列化和饭序列化](#42-1什么是序列化和饭序列化)auto    - [42-2：序列化的作用](#42-2序列化的作用)auto    - [42-3：java对象如何实现序列化](#42-3java对象如何实现序列化)auto    - [42-4：java对象如何实现反序列化](#42-4java对象如何实现反序列化)auto    - [42-5：哪些不会被序列化](#42-5哪些不会被序列化)auto    - [42-6：序列化协议有哪些](#42-6序列化协议有哪些)auto    - [42-7：该接口并没有方法和字段，为什么只有实现了该接口的类的对象才能被序列化呢？](#42-7该接口并没有方法和字段为什么只有实现了该接口的类的对象才能被序列化呢)auto    - [42-8: 什么是serialVersionUID](#42-8-什么是serialversionuid)autoauto<!-- /TOC -->
...
1. JDK1.7用的是头插法，而JDK1.8及之后使用的都是尾插法，JDK1.7采用头插法虽然能够提高插入的效率，但是为了安全,防止环
   化，因为resize的赋值方式，也就是使用了单链表的头插入方式，同一位置上新元素总会被放在链表的头部位置，在旧数组中同
   一条Entry链上的元素，通过重新计算索引位置后，有可能被放到了新数组的不同位置上。使用头插会改变链表的上的顺序，但是
   如果使用尾插，在扩容时会保持链表元素原本的顺序，保持之前节点的引用关系，就不会出现逆序且链表死循环的问题
...
* 由于ConcurrentHashMap对于会产生并发操作的node都会有加锁同步处理,且迭代器获取tab[index]开头node时都会从主存来获
  得,保证获取的数据是最新的，从而保证了迭代器在迭代过程中即使有put , remove等操作同时发生也可以保证迭代的安全性,不会
