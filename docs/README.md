 ...
 * @LastEditTime: 2020-04-26 22:40:50
...
|------------------------------------------------------------------|--------------|--------------------------|----------|-------------------|
| 之前内容                                                             |              | 基础部分                     | :wrench: |                   |
| 第10周                                                             | 4\.27\-5\.3  | TCP（共计15小时）              | :wrench: | "排序与链表基础          |
| 链表问题对于笔试和面试阶段的解题方法论                                              |
| 常见的链表面试题目                                                        |
| 利用快慢指针                                                           |
| 哈希表和有序表在使用层次上的简单介绍                                               |
...
| 图的深度优先遍历与宽度优先遍历                                                  |
| 拓扑排序问题"                                                          |
| 第11周                                                             | 5\.4\-5\.10  | 数据库（共计55小时）              | :wrench: | "最小生成树问题          |
| 单源最短路径问题                                                         |
| 详解前缀树                                                            |
| 介绍贪心算法及其相关题目                                                     |
| 在面试中如何快速的尝试出贪心策略                                                 |
...
| 大数据题目与空间限制题目常见解法                                                 |
| 位运算常见题目"                                                         |
| 第12周                                                             | 5\.11\-5\.17 | 数据库（共计55小时）              | :wrench: | "从暴力递归到动态规划（上）    |
| 从暴力递归到动态规划（下）与社会嗑                                                |
| 定长的绳子覆盖数轴上最多多少点                                                  |
| 捆绑交易恰好购买苹果问题                                                     |
| 4^x次幂吃草问题                                                        |
| 正方形01染色                                                          |
| 01矩阵输出边框全是1的最大正方形的边长长度                                           |
| 已知区间等概函数，设计新区间等概函数                                               |
| 限制最大值的子数组                                                        |
| 可以转换的不同字符串的个数                                                    |
| 括号序列问题                                                           |
| 树的路径最大权值和问题                                                      |
| "                                                                |
| 第13周                                                             | 5\.18\-5\.24 | 框架复习（7天）                 | :wrench: | "给定二叉树节点数求二叉树结构方案 |
| 机器人抓物品                                                           |
| 矩阵旋转90°                                                          |
| 有序二维数组找数是否在该数组中                                                  |
| 数组中找划分的最大值                                                       |
...
| 最长公共子序列                                                          |
| 最长公共子串                                                           |
| 斐波那契数列问题O\(logN\)的解法及其扩展                                         |
| 所有长度为N的字符串中达标字符串的数量                                              |
| 出现次数最多的前K个字符串                                                    |
| TopKRecord结构                                                     |
| "                                                                |
| 第14周                                                             | 5\.25\-5\.31 | 框架（46小时）                 | :wrench: | "输出路径中蕴含的目录结构     |
| 二叉树转化为有序双向链表                                                     |
| 找到一棵二叉树中的最大搜索二叉子树                                                |
| 给定中序和先序输出后序遍历                                                    |
| 安置路灯所需最少路灯数                                                      |
...
| 字符串的组合方式                                                         |
| 字符串中没有重复字符子串中最长的长度                                               |
| 删除字符串中字符使得每种字符只保留一个，并让字典序最小                                      |
| 字符串最短的变换路径                                                       |
| 未排序数组求排序后相邻两数最大差值ON                                              |
| 不重叠的非空区间数字的异或和等于0的数量                                             |
| 两个有序数组找k大                                                        |
| 公司招聘 约瑟夫环                                                        |
| "                                                                |
| 第15周                                                             | 6\.1\-6\.7   | 框架（46小时）                 | :wrench: | "给定大楼返回轮廓线数组      |
| 正值数组求所有的子数组中累加和等于k的最长子数组长度                                       |
| 无限制数组所有的子数组中累加和等于k的最长子数组长度                                       |
| 无限制数组所有的子数组中累加和小于等于k的最长子数组长度                                     |
| 拿铜板游戏 博弈论                                                        |
| 树上的最大路径和                                                         |
| 蛇形数组                                                             |
| 公式计算                                                             |
...
| 一个数拆分方案数                                                         |
| 有k个逆序对的排列数 dp                                                    |
| 给定二叉树头结点，返回最大的且符合搜索二叉树条件的最大拓扑结构的大小                               |
| 把数组\{L1,L2,\.\.,Ln,R1,R2,\.\.,Rn\}调整为\{R1,L1,R2,L2,\.\.,Rn,Ln\}" |
| 第16周                                                             | 6\.8\-6\.14  | 项目一（38小时）                | :wrench: | "项目分配问题           |
| 二叉树寻找错误结点                                                        |
| 山峰相见问题                                                           |
| 矩形重叠 二维前缀和                                                       |
| 通配符字符串匹配                                                         |
...
| 实现缓存结构                                                           |
| 加油站良好出发点问题"                                                      |
| 第17周                                                             | 6\.15\-6\.21 | 项目一（38小时）\+工具（Docker）    | :wrench: | 左程云书籍\+设计模式       |
| 第18周                                                             | 6\.22\-6\.28 | 项目二（64小时）                | :wrench: | 左程云书籍\+设计模式       |
| 第19周                                                             | 6\.29\-7\.5  | 项目二（64小时）                | :wrench: | 左程云书籍\+设计模式       |
| 第20周                                                             | 7\.6\-7\.12  | 项目二补充（23小时）\+工具（Ngnix）   | :wrench: |                   |
| 第21周                                                             | 7\.13\-7\.19 | 项目三（78小时）                | :wrench: |                   |
| 第22周                                                             | 7\.20\-7\.26 | 项目三（78小时）                | :wrench: |                   |
| 第23周                                                             | 7\.27\-8\.2  | 项目三（78小时）                | :wrench: |                   |
| 第24周                                                             | 8\.3\-8\.9   | linux\+shell（48小时）       | :wrench: |                   |
| 第25周                                                             | 8\.10\-8\.16 | linux\+shell（48小时）\+操作系统 | :wrench: |                   |
| 第26周                                                             | 8\.17\-8\.23 | JVM（30小时）                | :wrench: |                   |
| 第27周                                                             | 8\.24\-8\.30 | hadoop（32小时）\+面经复习       | :wrench: |                   |
| 第28周                                                             | 8\.31\-9\.6  | 面经复习                     | :wrench: |                   |
| 第29周                                                             | 9\.7\-9\.13  | 面经复习                     | :wrench: |                   |
| 第30周                                                             | 9\.14\-9\.20 | 面经复习                     | :wrench: |                   |
| 第31周                                                             | 9\.21\-9\.27 | 面经复习                     | :wrench: |                   |
| 第32周                                                             | 9\.28\-10\.4 | 面经复习                     | :wrench: |                   |
